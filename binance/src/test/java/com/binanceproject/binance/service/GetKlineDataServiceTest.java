...
class GetKlineDataServiceTest {
    ...
    void testGetKlineDataSuccess() {
        ...
        //When
        when(binanceRepository.findSymbolAndOpenTimeAndCloseTime(symbol, startTime, endTime)).thenReturn(expectedData);
        // Call the method you want to test
        List<Kline> result = getKlineDataService.getKlineData(symbol, startTime, endTime);
        // Assert the result
